...
public class switchTo_method_byusing_index 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		//Method 1)----->By using index of iframe tag
		driver.switchTo().frame(1);     //Switch to the particular frame    //here index starts from 0
		Thread.sleep(2000);
